...
<head>
    <meta charset="utf-8">
    <title>Paws and Claws - Pet Shelter</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">

    <!-- Favicon -->
    <link href="design/img/favicon.ico" rel="icon">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        <a href="index.html" class="navbar-brand ms-lg-5">
            <h1 class="m-0 text-uppercase text-dark"><i class="bi bi-shop fs-1 text-primary me-3"></i>Pet Shelter</h1>
        </a>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-uppercase text-dark mb-lg-4">Paws and Claws</h1>
                    <h1 class="text-uppercase text-white mb-lg-4">Ensure Your Pets Feel Right at Home</h1>
    ...
    <!-- About End -->
        ...
        <!-- Pets carousell Start -->
        <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                <h6 class="text-primary text-uppercase">Sheltered Pets</h6>
            ...
            @foreach($all as $animal)
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="{{ asset($animal->img_path)}}" alt="">
                        <h6 class="text-uppercase"><strong>NAME:</strong> {{$animal->animal_Name}}</h6>
                        <h5 class="text-primary mb-0"><strong>AGE:</strong> {{$animal->animal_Age}}</h5>
    ...
    <script src="design/lib/waypoints/waypoints.min.js"></script>
